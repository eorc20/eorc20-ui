...
import BunnyIcon from "@inscription/uikit/src/components/Svg/Icons/Logo";
import { BunnyProps, FallingBunniesProps } from "@inscription/uikit/src/components/FallingBunnies/types";
