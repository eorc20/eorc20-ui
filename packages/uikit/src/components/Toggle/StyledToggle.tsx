...
import { ToggleProps, HandleProps, InputProps, ScaleKeys, scales, StyleToggleProps } from "@inscription/uikit/src/components/Toggle/types";
...
export const Handle = styled.div<HandleProps>`
  ...
  background-color: ${({ theme, $checked }) => ($checked ? theme.toggle.handleBackground : "#7F7F7F")};
  border-radius: 50%;
  cursor: pointer;
