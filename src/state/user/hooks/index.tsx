/* eslint-disable */
import { ChainId, Pair, Token } from '../../../../packages/swap-sdk/src/index'
...
export function useGasPrice(): string {
  ...
  //   chainId,
  //   enabled: chainId !== ChainId.EVM_NET && chainId !== ChainId.EVM_TESTNET,
  //   watch: true,
  // })
  // const { data: signer } = useSigner()
  // const { data: eosProviderGasPrice = GAS_PRICE_GWEI.default } = useSWR(
  //   signer &&
  //   (chainId === ChainId.EVM_NET || chainId === ChainId.EVM_TESTNET) &&
  //   userGas === GAS_PRICE_GWEI.rpcDefault && ['eosProviderGasPrice', signer],
  //   async () => {
  //     const gasPrice = await signer.getGasPrice()
  //     console.log(gasPrice, 'gasPrice1111')
  ...
  if (chainId === ChainId.EVM_NET || chainId === ChainId.EVM_TESTNET) {
    return GAS_PRICE_GWEI.rpcDefault === 'rpcDefault' ? GAS_PRICE_GWEI.default : userGas
  }
  return userGas
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Inscription-LP', 'Inscription LPs')
}
