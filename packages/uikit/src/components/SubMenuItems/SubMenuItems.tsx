...
import { ChevronLeftIcon, ChevronRightIcon, OpenNewIcon } from "@inscription/uikit/src/components/Svg";
import StyledSubMenuItems, {
  LeftMaskLayer,
  RightMaskLayer,
  StyledSubMenuItemWrapper,
  SubMenuItemWrapper,
} from "@inscription/uikit/src/components/SubMenuItems/styles";
import { SubMenuItemsProps } from "@inscription/uikit/src/components/SubMenuItems/types";
