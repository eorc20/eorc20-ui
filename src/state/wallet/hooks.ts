/* eslint-disable */
// import { Currency, CurrencyAmount, JSBI, Native, Token } from '@inscription/sdk'
...
/**
 * Returns a map of the given addresses to their eventually consistent EOS balances.
 */
...
//   // console.log('wallet/hooks.ts', '执行了getCoinList')
