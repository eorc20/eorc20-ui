...
import { mountAnimation, unmountAnimation } from "@inscription/uikit/src/components/BottomDrawer/styles";
import { Overlay } from "@inscription/uikit/src/components/Overlay";
import { useIsomorphicEffect } from "@inscription/uikit/src/hooks";
import {
  animationHandler,
  animationMap,
  animationVariants,
  appearAnimation,
  disappearAnimation,
} from "@inscription/uikit/src/util/animationToolkit";
import { ModalContainer } from "@inscription/uikit/src/widgets/Modal/styles";
import { Handler } from "@inscription/uikit/src/widgets/Modal/types";
