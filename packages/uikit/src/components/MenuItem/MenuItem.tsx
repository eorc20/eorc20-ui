...
import StyledMenuItem, { StyledMenuItemContainer } from "@inscription/uikit/src/components/MenuItem/styles";
import { MenuItemProps } from "@inscription/uikit/src/components/MenuItem/types";
