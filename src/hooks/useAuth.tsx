...
import { Box, connectorLocalStorageKey, ConnectorNames, LinkExternal, Text } from '@inscription/uikit'
        ...
        if (error instanceof ConnectorNotFoundError) {
          toastError(
            ...
            <Box>
              ...
              <LinkExternal href="https://docs.public.pro/get-started/connection-guide">
                {t('Need help ?')}
              </LinkExternal>
            </Box>,
          )
