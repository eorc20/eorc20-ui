...
const langs: any = [...Array(20)].map((_, i) => ({ code: `en${i}`, language: `English${i}` }));
...
const useProps = () => {
  const [props, setProps] = useState({
    ...
    setLang: noop,
    currentLang: "EN",
    publicPriceUsd: 0.023158668932877668,
    links,
    profile: null,
  });
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang="EN"
        publicPriceUsd={0.23158668932877668}
        links={links}
        profile={{
          profileLink: "/profile",
    ...
    <BrowserRouter>
      <Menu
        ...
        profile={{
          ...
          image: "https://public.pro/images/nfts/blueberries-preview.png",
          profileLink: "/profile",
          noProfileLink: "/no-profile",
        }}
      >
