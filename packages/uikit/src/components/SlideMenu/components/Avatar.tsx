...
import { Profile } from "@inscription/uikit/src/components/SlideMenu/types";
import NoProfileAvatar from "@inscription/uikit/src/components/Svg/Icons/NoProfileAvatar";
